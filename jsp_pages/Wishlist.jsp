					...
					<div class="row">
						<div class="col-xs-10 col-md-6">
							<div class="panel panel-default" style="max-width:500px;margin-left:auto;margin-right:auto;">
								<div class="panel-heading">
									<center><font size="5">My Wishlist</font></center>	
								</div>
								...
								adids=wish.getWishlist(purchaser_id);
								if (adids.size()==0){%>
							...
							for (int i=0; i<adids.size() ; i++){
								...
								Ad ad1=new Ad();
								Ad ad=ad1.getSpecificAd(adid);
								%>

								<ul class="list-group" style="max-width:500px;margin-left:auto;margin-right:auto;">
									<li class="list-group">

<li><h3 class="media-heading"> <font size="5" color="black"> <img class="media-object" width="155" height="120" src="<%=ad.getPhoto()%>" alt="Photo">
 </font></h3></li>

									<b>Price:</b> <%=ad.getPrice()%><br>
									<b>Description:</b> <%=ad.getProductDescription()%><br>
									<b>Category:</b> <%=ad.getProductType()%><br>

									<form class="form-horizontal" id="form1" name="form1" method="post" action="WishlistController.jsp">
											<div class="form-group last">
												<div class="col-sm-offset-8 col-sm-10">
													<input type="hidden" id="custId" name="adid" value="<%=ad.getAd_id()%>">
													<button type="submit" id="A"class="btn btn-danger btn-sm" name="decline" value="decline"><i class="fa fa-trash" style="font-size:18px"></i> Delete</button>												</div>
											</div>
										</form>
