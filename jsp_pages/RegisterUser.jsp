				...
				<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-default" style="max-width:420px;margin-left:auto;margin-right:auto;">
						<div class="panel-heading">
							<center><b>Register as Purchaser</b></center>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" id="form1" name="form1" method="post" action="RegisterUserController.jsp" enctype="multipart/form-data" >
								...
								<div class="form-group">
									<label for="inputAge" class="col-sm-2 control-label">Date&nbsp;of Birth</label>
									<div class="col-sm-9" style="float:right;">
						...
						<div class="panel-footer">
							Register as NGO?<a href="http://ism.dmst.aueb.gr/ismgroup38/omadiki/RegisterMKO.html">  Register here</a> 
						</div>	
					</div>
				</div>
			</div>
