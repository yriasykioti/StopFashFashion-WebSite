				...
				<div class="panel panel-default">
					<form class="form-horizontal" id="form1" name="form1" method="post" action="BuyController.jsp">
						<div class="form-group">
							<h5> If you want to make another search please press here </h5>
						...
						<div class="row">
							...
							<div class="col-xs-12 text-center">								
								...
								<input type="hidden" id="custId" name="photo" value="<%=ad1.getPhoto()%>">
									...
									<button type="submit" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-info-sign"></span>Ask for info</button>
								</form>
								...
								<button type="submit" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-heart"></span>Add to wishlist</button>
								</form>
							</div> <!-- /col-xs-12 -->
						</div> <!-- /row -->
					</div> <!-- /caption -->
